        ...
        <div id="content" class="clearfix">
            ...
            <div class="main">
                ...
                if (isset($_POST["username"])){
                    $costumerUsername = $_POST["username"];
                }else{
                    echo "All fields need to be filled";
                    header("Location: index.php");
                    exit();
                ...
                $sql = "INSERT INTO users(firstName,lastName,emailAddress, emailHash, username,passwrd)VALUES ('$firstName','$lastName','$emailAddress','$emailHash','$costumerUsername','$passwrd')";
